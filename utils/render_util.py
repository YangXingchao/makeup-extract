...
def compute_img_render(glctx, mm_ret, uv_ret, tri, uvs, uv_ids, fit_size):
    ...
    ret = {'rncr': rncr, 'rndr': rndr, 'diff': diff, 'albe': albe, 'rnsr': rnsr, 'refl': refl, 'spec': spec, 'norm':norm}
...
def compute_uv_render(mm_ret, rast_uv, tri, mask):
    ...
    ret = {'rncr': rncr, 'rndr': rndr, 'diff': diff, 'albe': albe, 'rnsr': rnsr, 'refl': refl, 'spec': spec, 'norm': norm, 'vert': vert}
